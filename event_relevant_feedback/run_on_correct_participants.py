"""
run_on_correct_participants.py
------------------------------
Runs build_window_datasets + fill_nan_values on:
  correct_All_participants.xlsx

Output folder:
  .../דיבאג/correct_participants_windows/
"""
...
# ─── Paths ───────────────────────────────────────────────────────────────────
INPUT_PATH = r"C:\Users\ASUS VIVOBOOK\Desktop\אוניברסיטה\תואר שני\תזה\קוד\claude code\event relavent feedback\correct_All_participants.csv"
OUTPUT_DIR = r"C:\Users\ASUS VIVOBOOK\Desktop\אוניברסיטה\תואר שני\תזה\קוד\claude code\event relavent feedback\correct_participants_windows"
...
# first_feedback_relavet_to_event == 1 marks the row where first feedback occurred.
# We take its time_since_event_start_world as the feedback timestamp per event.
...
def clean_dataset(df: pd.DataFrame, label: str) -> pd.DataFrame:
    ...
    if remaining_nan_cols:
        ...
        print(f"\n  OK: No remaining NaN values in numeric columns.")
